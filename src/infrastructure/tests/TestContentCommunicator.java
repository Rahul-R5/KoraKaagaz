 ...
 */
public class TestContentCommunicator implements IContentCommunicator{
	/**
	 ...
	 */
	private IServerPort serverPort = TestContentFactory.getTestServerPort();
	/**
	 ...
	 */
	protected TestContentCommunicator() {
		nmh = new TestNetworkMessageHandler();
