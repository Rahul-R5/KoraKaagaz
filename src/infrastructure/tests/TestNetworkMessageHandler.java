 ...
 * @author Talha Yaseen
 */
public class TestNetworkMessageHandler implements INotificationHandler {
	...
	*/
	 ...
	 */
	private static HashMap<String, IContentNotificationHandler> handlerMap = TestContentCommunicator.getHandlerMap();
	
	/**
	 * Accessing imageMap hashmap from ContentCommunicator class to access image corresponding to username
	 */
	private static HashMap<String, String> imageMap = TestContentCommunicator.getImageMap();
	...
	public void onMessageReceived(String message) {
		...
		if(metafield.equals("newUser")) {
			...
			TestContentCommunicator.setImageMap(imagemap);
			logger.log(
				ModuleID.INFRASTRUCTURE, 
				LogLevel.SUCCESS, 
